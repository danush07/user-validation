...
function AddUserCanvas({ onClose }) {
...
const handleCreateUser = async (e) => {
  ...
  return (
    <div>
      <div
        id="drawer-form"
        className="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform ease-in-out bg-white w-2/3 dark:bg-gray-800"
        tabIndex="-1"
        ...
        <form className="mb-2 grid grid-cols-2 gap-4">
          ...
          <div class="mb-2">
            ...
            <PhoneInput
              ...
              placeholder="Example : +91 933734253"
